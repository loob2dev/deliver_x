                    ...
                    <View style={styles.row}>
                      <View style={styles.col}>                  
                        <Input
                            ...
                            disabled={true}
                            value={this.state.data.senderAddressID}
                         />
                      </View>
                    </View>
                    <View style={styles.row}>
                      <View style={styles.col}>
                        <Input
                            ...
                            disabled={true}
                            value={this.state.data.senderEmail}
                        />
                      </View>
                      <View style={styles.col}>
                        <Input
                            ...
                            disabled={true}
                            value={this.state.data.senderPhone}
                        />
                      </View>
                    </View>
                    <View style={styles.row}>
                      <View style={styles.col}>
                        <Input
                            label='Street'
                            disabled={true}
                            value={this.state.data.senderStreet}
                        />
                      </View>
                      <View style={styles.col}>
                        <Input
                            ...
                            keyboardType="numeric"
                            disabled={true}
                            value={this.state.data.sender_street_nr}
                        />
                      </View>
                    </View>
                    <View style={styles.row}>
                      <View style={styles.col}>                  
                        <Input
                            label='City'
                            disabled={true}
                            value={this.state.data.senderHouseNr}
                        />
                      </View>
                    </View>
                    <View style={styles.row}>
                      <View style={styles.col}>
                        <Input
                            ...
                            keyboardType="numeric"
                            disabled={true}
                            value={this.state.data.senderZip}
                        />
                      </View>
                      <View style={styles.col}>
                        <Input
                            label='Country'
                            disabled={true}
                            value={this.state.data.senderCountry}
                        />
                      </View>
                    </View>
                    <Text style={styles.subTitle}>
                    ...
                    <View style={styles.row}>
                      <View style={styles.col}>
                         <Input
                            ...
                            keyboardType="numeric"
                            disabled={true}
                            value={this.state.data.senderLatitude.toString()}                            
                        />
                      </View>
                      <View style={styles.col}>
                         <Input
                            ...
                            keyboardType="numeric"
                            disabled={true}
                            value={this.state.data.senderLongitude.toString()}
                        />
                      </View>
                    </View>
                      ...
                      return (
                        <View key={index}>
                            ...
                            <View style={styles.row}>
                              <View style={styles.col}>
                                 <Input
                                    ...
                                    keyboardType="numeric"
                                    disabled={true}
                                    value={item.receiverLatitude.toString()}
                                />
                              </View>
                              <View style={styles.col}>
                                 <Input
                                    ...
                                    keyboardType="numeric"
                                    disabled={true}
                                    value={item.receiverLongitude.toString()}
                                />
                              </View>
                            </View>
                            <Text style={styles.label_data}>
                            ...
                            <View style={[styles.col, {marginBottom: 20}]}>
                             ...
                             label='ParcelPrice'
                              keyboardType="numeric"
                              value={item.parcelValue.toString()}
                              />
                            </View>
                        </View>
                      )
